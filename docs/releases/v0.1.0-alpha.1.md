...
> Documentation correction: the published Alpha 1 binary registers `Ctrl+Alt+T`. Earlier documentation that said `Ctrl+Shift+T` was incorrect. The published binary itself is unchanged.

## What works

- Select text in a Windows application and invoke `Ctrl+Alt+T`.
